...
(function () {
  ...
  // apprendre-arabe est FR uniquement. On garde la signature L(fr, en) pour
  // rester en sync avec learn-arabic ; on ignore simplement le second argument.
  function L(fr) { return fr; }
  ...
  const T = {
    ...
    plural_f: {
      ...
      make: function () {
        ...
        // typiques : appliquer la règle masculine (ون), ou garder ة puis ات.
    ...
    plural_of: {
      ...
      make: function () {
        // Limité aux pluriels BRISÉS : le sain-féminin est traité par plural_f.
    ...
    nominal_parts: {
      ...
      make: function () {
        ...
        // reste au masculin dans les deux langues.
